...
/// Écran permettant à un client de créer un compte.
...
class _CreationCompteState extends State<CreationCompte> {
  ...
  /// Vérifie les informations puis crée un nouveau compte.
  void _handleSignUp() {
  ...
  /// Bouton utilisé pour les actions d'inscription.
